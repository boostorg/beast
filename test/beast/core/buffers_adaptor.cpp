...
public:
    ...
    testSpecial()
    {
        ...
        char s2[13];
        buffers_triple tb2(s1, sizeof(s2));
...
#if 0
        {
            buffers_adaptor<buffers_triple> b(tb1);
            test_buffer_sequence(*this, b.prepare(13));
            b.commit(13);
            test_buffer_sequence(*this, b.data());
            test_buffer_sequence(*this, b.cdata());
        }
#endif
    }
