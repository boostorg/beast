...
public:
    ...
    public:
        ...
        void
        operator()(int v, boost::core::string_view s)
        {
            fail_ = false;
            BEAST_EXPECT(v == 42);
            BEAST_EXPECT(s == "s");
        ...
        void
        operator()(int v, boost::core::string_view s, move_arg<1>)
        {
            fail_ = false;
            BEAST_EXPECT(v == 42);
            BEAST_EXPECT(s == "s");
        ...
        void
        operator()(int v, boost::core::string_view s, move_arg<1>, move_arg<2>)
        {
            fail_ = false;
            BEAST_EXPECT(v == 42);
            BEAST_EXPECT(s == "s");
        ...
        void
        operator()(
            error_code, std::size_t n, boost::core::string_view s)
        {
    ...
    testBindFrontHandler()
    {
        ...
        // void(error_code, size_t)(boost::core::string_view)
