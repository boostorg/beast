...
public:
    ...
    */
    ...
    to_vector(boost::core::string_view in)
    {
    ...
    template<class Policy>
    void
    validate(boost::core::string_view in,
    ...
    template<class Policy>
    void
    good(boost::core::string_view in)
    {
