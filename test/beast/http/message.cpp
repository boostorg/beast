...
public:
    ...
    //BOOST_CORE_STATIC_ASSERT(! std::is_constructible<request<one_arg_body>,
    //    verb, boost::core::string_view, unsigned>::value);

    BOOST_CORE_STATIC_ASSERT(std::is_constructible<request<one_arg_body>,
        verb, boost::core::string_view, unsigned, Arg1>::value);

    BOOST_CORE_STATIC_ASSERT(std::is_constructible<request<one_arg_body>,
        verb, boost::core::string_view, unsigned, Arg1&&>::value);

    BOOST_CORE_STATIC_ASSERT(std::is_constructible<request<one_arg_body>,
        verb, boost::core::string_view, unsigned, Arg1 const>::value);
    ...
    // 1-arg + fields
    BOOST_CORE_STATIC_ASSERT(std::is_constructible<request<one_arg_body>,
        verb, boost::core::string_view, unsigned, Arg1, fields::allocator_type>::value);
    ...
    struct test_fields
    {
        ...
        test_fields() = delete;
        test_fields(token) {}
        boost::core::string_view get_method_impl() const { return {}; }
        boost::core::string_view get_target_impl() const { return target; }
        boost::core::string_view get_reason_impl() const { return {}; }
        ...
        void set_target_impl(boost::core::string_view s) { target = std::string(s); }
