...
struct fields_model
{
    ...
    boost::core::string_view method() const;
    boost::core::string_view reason() const;
    boost::core::string_view target() const;

protected:
    boost::core::string_view get_method_impl() const;
    boost::core::string_view get_target_impl() const;
    boost::core::string_view get_reason_impl() const;
    bool get_chunked_impl() const;
    bool get_keep_alive_impl(unsigned) const;
    bool has_content_length_impl() const;
    void set_method_impl(boost::core::string_view);
    void set_target_impl(boost::core::string_view);
    void set_reason_impl(boost::core::string_view);
...
struct is_fields_helper : T
{
    ...
    static auto f1(int) -> decltype(
        std::declval<boost::core::string_view&>() = std::declval<U const&>().get_method_impl(),
        std::true_type());
    ...
    static auto f2(int) -> decltype(
        std::declval<boost::core::string_view&>() = std::declval<U const&>().get_target_impl(),
        std::true_type());
    ...
    static auto f3(int) -> decltype(
        std::declval<boost::core::string_view&>() = std::declval<U const&>().get_reason_impl(),
        std::true_type());
    ...
    static auto f7(int) -> decltype(
        void(std::declval<U&>().set_method_impl(std::declval<boost::core::string_view>())),
        std::true_type());
    ...
    static auto f8(int) -> decltype(
        void(std::declval<U&>().set_target_impl(std::declval<boost::core::string_view>())),
        std::true_type());
    ...
    static auto f9(int) -> decltype(
        void(std::declval<U&>().set_reason_impl(std::declval<boost::core::string_view>())),
        std::true_type());
