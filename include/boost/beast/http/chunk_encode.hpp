...
public:
    ...
    */
    ...
    /** Constructor
        ...
        be convertible to @ref boost::core::string_view. This object will be copied
    ...
    template<class ChunkExtensions
        ...
        , class = typename std::enable_if<
            ! std::is_convertible<typename std::decay<
                ChunkExtensions>::type, boost::core::string_view>::value>::type
#endif
    >
    chunk_body(
        ConstBufferSequence const& buffers,
...
class basic_chunk_extensions
{
    ...
    void
    do_insert(boost::core::string_view name, boost::core::string_view value);
...
public:
    ...
    */
    using value_type = std::pair<boost::core::string_view, boost::core::string_view>;
    ...
    */
    void
    parse(boost::core::string_view s, error_code& ec);
    ...
    */
    void
    insert(boost::core::string_view name);
