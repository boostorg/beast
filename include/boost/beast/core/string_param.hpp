...
public:
    ...
    /** Constructor
        ...
        of a @ref boost::core::string_view.
    ...
    */
    ...
    /// Implicit conversion to @ref boost::core::string_view
    operator boost::core::string_view const() const
    {
        return sv_;
    }
};
